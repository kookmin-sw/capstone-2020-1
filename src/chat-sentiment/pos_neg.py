...
epoch = 10
if not os.path.isfile('chat_sentiment_model'+str(selected_words_num)+'_'+str(epoch)+'.h5'):
    ...
    model.save('chat_sentiment_model'+str(selected_words_num)+'_'+str(epoch)+'.h5')
else:
    model = load_model('chat_sentiment_model'+str(selected_words_num)+'_'+str(epoch)+'.h5')
